...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
       <!-- <style type="text/css">
          body {
            background-image: url("<?php echo base_url(); ?>templates/images/background/back_panel.jpg"); 
        ...
        <script src="<?php echo base_url(); ?>templates/js/display.min.js" type="text/javascript"></script>         
                ...
                <tr>
                  <?php 
                    ...
                    <td align="center" style="padding:20px;">
                      ...
                      <br /><font size="3.5"><?php echo $smiley_data[$i-1]['Caption_Ms']; ?></font>
