         ...
         <!--  <form action="#" method="get" class="sidebar-form">
          ...
          <ul class="sidebar-menu">
           ...
           <!--  <li class="treeview">
            ...
            <li class="treeview">
              <a href="<?php echo base_url(); ?>index.php/coor-configuration">
                <i class="fa fa-cog"></i>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content"
                  ...
                  onclick="javascript:location.href='<?php echo base_url(); ?>index.php/coor-erating-list'">                
                  <span class="info-box-text">Agensi e-Ratinged</span>
...
<!--                 <div class="small-box" style="margin:9px 0 0 90px;">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content"
                  onMouseOver="this.style.cursor='pointer'"
                  onclick="javascript:location.href='<?php echo base_url(); ?>index.php/coor-report'">                
