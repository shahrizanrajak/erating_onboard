      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="<?php echo base_url(); ?>index.php/peng-dashboard">
           ...
           <!--  <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url(); ?>index.php/peng-erating-list"><i class="fa fa-user-plus"></i> Kemaskini Pengguna</a></li>
               
              </ul>
            </li>  -->   
           <!--  <li class="treeview">
              <a href="<?php echo base_url(); ?>index.php/peng-configuration">
                <i class="fa fa-cog"></i>
...
<!--                     <div id="validate_status" class="validate-status" style="padding-bottom:10px;"></div>
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class='fa fa-ban'></i> QR Code</button>                      
