...
$pdf->Image($img_file, 0, 0, 230, 297, '', '', '', false, 300, '', false, false, 0);
 ...
 //$gambar = base64_decode('photo');

// The '@' character is used to indicate that follows an image data stream and not an image file name
// $pdf->Image( base_url() . 'templates/images/noimage.png' , 100, 15, 35, 35);
$pdf->Image( base_url() . 'global/tmp/qr_codes/' . $uId . '.png' ,75, 50, 75, 80); 
$pdf->Image( $gambar , 5, 50, 70, 80);
