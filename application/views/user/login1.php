...
<link href="<?php echo base_url(); ?>templates/adminlte/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- Font Awesome Icons -->
    <link href="<?php echo base_url(); ?>templates/css/login.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
   
    <!-- iCheck -->
    <link href="<?php echo base_url(); ?>templates/dev/login.js" rel="stylesheet" type="text/css" />
