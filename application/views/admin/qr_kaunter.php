  ...
  <div class="form-group">    
    <div align="center">
      ...
      <!--     
        ...
        <div class='starrr' data-numstars='5' data-connected-input='rating'></div>
        <br /><br>
        <input type='hidden' id='rating' name='rating' value='' style="text-align:center; font-size:40px" placeholder="Pilihan anda.."/>  
...
{  
    ...
    var root = 'http://localhost/erating';
    var uId = $('#user_id').val();
