...
*/
// $config['base_url'] = '';
$config['base_url'] = 'http://test-erating-dev.apps.osdec.gov.my/erating';
...
$config['csrf_token_name'] = 'csrf_erating_token';	//csrf_test_name
$config['csrf_cookie_name'] = 'csrf_erating_cookie'; //csrf_cookie_name
